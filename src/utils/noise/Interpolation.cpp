...
float Interpolation::biLinearInterpolation(
...
float Interpolation::triLinearInterpolation(
...
float Interpolation::cubicInterpolation(float x0, float x1, float x2, float x3, float t)
{
    a = x3 - x2 - x0 + x1;
    b = x0 - x1 - a;
    c = x2 - x0;
...
float Interpolation::biCubicInterpolation(float x0y[4], float x1y[4], float x2y[4], float x3y[4], float x)
{
